...
The XRP platrorm is a small inexpensive robot which has a supported interface to regular Java FRC code via the simulator. This makes it ideal for students to learn without having a working full FRC robot.
